    ...
    for ver5 in ver4:
        ...
        if ver6 == ver:  # prompt for the update
            ...
            v1 = input(
                ...
                + ver6
                + "\u001b[0m"
                + " is now available, If you wish to do an update please go to the root directory of alt2 via \e[32/alt2\e[39m then search and run ./parser.sh with sudo priviledges.\n Do you wish to continue without update? (Y/N) \u001b[37;1m|\u001b[0m Default is (\u001b[32mY\u001b[0m): "
            )
